...
public class Program
{
	...
	public static string Folder = @"D:\visual studio code\ElectrumDev Website\WebDB\WebDB\";
	public static string Database = @"URI=file:D:\visual studio code\ElectrumDev Website\WebDB\WebDBS.db";
	public static string Namespace = @"WebDB";
	...
	public static void Main()
	{
		...
		foreach (string TableName in tables)
		{
			...
			using (var con = new SQLiteConnection(Database))
			{
				...
				string[] tempStats = WrapItems(recs: "using (IDbConnection con = new SqlConnection(CommonData.db))", suite: usingStatments);
				...
				tempStats = WrapItems(recs: "using (IDbConnection con = new SqlConnection(CommonData.db))", suite: usingStatments);
				...
				string finalAccess = "using Microsoft.Data.SqlClient; using System; using Dapper; using System.Data;\n" + WrapToString(WrapFinal);
